...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    pumpEfficiency: function pumpEfficiency() {
      ...
      var motorEfficiencyDecimal = this.form_data.pumpMotorEfficiencyRated / 100;

      // Calculate numerator and denominator separately for clarity
      var numerator = this.form_data.pumpFlowMeasured * (this.form_data.pumpDischargeHeadMeasured + this.form_data.pumpSuctionHeadMeasured) * 9.81;
      var denominator = 3600 * this.form_data.pumpMotorPowerMeasured * motorEfficiencyDecimal;
    ...
    airCompressorFlow: function airCompressorFlow() {
      ...
      var timeInSeconds = this.form_data.airCompressorTimeToReachFinalPressureMeasured * 60;

      // Avoid division by zero
      if (timeInSeconds <= 0) return 0;

      // Calculate flow using the provided formula
      return 0.987 * (this.form_data.airCompressorFinalPressureMeasured - this.form_data.airCompressorInitialPressureMeasured) * (this.form_data.airCompressorRecieverSizeMeasured + this.form_data.airCompressorPipeVolumeMeasured) / timeInSeconds;
    },
    compressorSEC: function compressorSEC() {
      // Convert CFM to m³/min (0.0283 conversion factor)
      var flowInM3PerMin = this.form_data.airCompressorFlowMeasured * 0.0283;
    ...
    leakagePercentageOne: function leakagePercentageOne() {
      ...
      var load = Number(this.form_data.airCompressorLoadTimeReadingOne);
      var unload = Number(this.form_data.airCompressorUnLoadTimeReadingOne);
    ...
    leakagePercentageTwo: function leakagePercentageTwo() {
      // Convert to numbers explicitly
      var load = Number(this.form_data.airCompressorLoadTimeReadingTwo);
      var unload = Number(this.form_data.airCompressorUnLoadTimeReadingTwo);
      var total = load + unload;
      if (total <= 0) return 0;
    ...
    leakagePercentageThree: function leakagePercentageThree() {
      // Convert to numbers explicitly
      var load = Number(this.form_data.airCompressorLoadTimeReadingThree);
      var unload = Number(this.form_data.airCompressorUnLoadTimeReadingThree);
      var total = load + unload;
      if (total <= 0) return 0;
