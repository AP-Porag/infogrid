...
/* harmony import */ var vue_sweetalert2__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! vue-sweetalert2 */ "./node_modules/vue-sweetalert2/dist/vue-sweetalert.mjs");
...
Vue.use((vue_form_wizard__WEBPACK_IMPORTED_MODULE_1___default()));
...
Vue.mixin({
  methods: {
    showValidationError: function showValidationError(err) {
      var error_string = '<div class="error-sa-v text-left">';
    ...
    showSomethingWrong: function showSomethingWrong() {
      var timerInterval;
      Vue.swal({
        icon: "error",
